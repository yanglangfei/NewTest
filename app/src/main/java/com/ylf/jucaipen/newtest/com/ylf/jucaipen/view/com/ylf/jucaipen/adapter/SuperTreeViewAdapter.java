...
public class SuperTreeViewAdapter extends BaseExpandableListAdapter {
    ...
    static public class SuperTreeNode {
        ...
        //二级树形菜单的结构体
        public List<ThreeViewAdapter.TreeNode> childs = new ArrayList<ThreeViewAdapter.TreeNode>();
    }
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        List<ThreeViewAdapter.TreeNode> tmp = treeViewAdapter.GetTreeNode();//临时变量取得TreeViewAdapter的TreeNode集合，可为空
        final ThreeViewAdapter.TreeNode treeNode=(ThreeViewAdapter.TreeNode) getChild(groupPosition, childPosition);
        tmp.add(treeNode);
